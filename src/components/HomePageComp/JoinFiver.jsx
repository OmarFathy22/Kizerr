...
const JoinFiver = () => {
  return (
    ...
    <div className='absolute left-[100px] top-[100px] flex flex-col gap-[30px]'>
        ...
        <button className=' text-white text-[18px] font-semibold bg-[var(--primaryColor)] max-w-[150px] py-[10px] rounded-[5px] hover:opacity-[0.9] transition-all'>Join Fiverr</button>
    </div>
